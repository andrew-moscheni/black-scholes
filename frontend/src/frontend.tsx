...
import '../style.css'; // Import your custom stylesheet alongside Tailwind
...
export default function OptionPricingEngine() {
  ...
  return (
    // Using Tailwind classes for base layout, combined with custom classes if desired
    <div className="dashboard-container min-h-screen bg-gray-50 flex flex-col font-sans">
      <header className="header-bar bg-slate-900 text-white p-6 shadow-md">
        <h1 className="text-3xl font-bold tracking-tight">Option Pricing Engine</h1>
      </header>

      <div className="main-content flex flex-1 flex-col md:flex-row p-6 gap-6 max-w-7xl mx-auto w-full">
        <aside className="sidebar w-full md:w-1/3 lg:w-1/4 bg-white p-6 rounded-lg shadow-sm border border-gray-200 h-fit">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={loading} className="calculate-btn w-full bg-blue-600 text-white font-semibold py-2 px-4 rounded hover:bg-blue-700 transition-colors disabled:bg-blue-400 mt-4">
        ...
        <main className="content-area w-full md:w-2/3 lg:w-3/4 bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="table-card">
            ...
            {results && (
              <div className="overflow-x-auto">
                <table className="pricing-table w-full text-left border-collapse">
                  <thead>
